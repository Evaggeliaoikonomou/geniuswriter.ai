      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-white bg-green-700 rounded-full mb-4">
              Reach goals that matter
            </div>
            <h1 className="h2 mb-4 tracking-tight">One product, infinite solutions.</h1>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <h3 className="h3 mb-3">Tame the Chaos, Embrace the Calm: Introducing Your Hassle-Free Dashboard
</h3>
                  <p className="text-lg text-gray-400 mb-4">
                  <span className='font-bold'>Time Saved, Tasks Achieved</span>: Forget struggling with clunky interfaces and deciphering confusing instructions. Our intuitive tools integrate seamlessly with the dashboard, allowing you to focus on what matters most - getting things done efficiently.
                  </p>
